            ...
            <nav class="container">
                <div class="row">
                    ...
                    <div class="col-md-7 col-md-offset-2 col-xs-8 col-xs-offset-0 text-right">
                        <ul class="row mr-0">
                            <li class="col-xs-5 text-right bold size-normal">
                                <span class="fa fa-phone"></span> Hotline: 0981 228 979
                            </li>
                            <li class="col-xs-7 text-right bold size-normal">
...
//                            echo "<input type='hidden' name='code_chanel' value=" . $code_chanel . ">";
                ...
                <div class="col-xs-4 border radius-5">
            ...
            <div class="row">
                <div class="col-xs-12" style=" padding:20px;  border: 1px solid #ccc; border-radius: 5px;">
                    ...
                    </div> <span style="font-style: italic;">Sau khi nhận được thanh toán, chương trình sẽ liên hệ lại với bạn qua số điện thoại để xác nhận và sắp xếp thời gian buổi học thử.
                        Lưu ý: cách làm này mất thời gian hơn thanh toán trực tiếp qua Bảo Kim. Nếu có bất cứ thắc mắc nào, hãy liên hệ hotline <span style="color:#810c15">0981 228 979</span> để được hỗ trợ.</span><br/>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-5">
                    <i>
                        ...
                        Số điện thoại hotline: <b>0981 228 979</b> hoặc Email: <b>topica.native@topica.edu.vn</b>
                    </i><div class="col-xs-5"><i style="color: #800c15;">											- Chương trình học chỉ hỗ trợ học trên máy tính để bàn hoặc laptop.<br />												- Học viên vui lòng không sử dụng điện thoại hoặc máy tính bảng để học											</i>				</div>															
                </div>
