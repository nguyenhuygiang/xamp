...
$id = isset($_GET["id"]) ? $_GET["id"] : "2252";
$preview = isset($_GET["preview"]) ? $_GET["preview"] : "-100";
$code_chanel = isset($_GET["code_chanel"]) ? $_GET["code_chanel"] : "TOPICANATIVEEDUVN01";
            ...
            $(document).ready(function () {
                $(window).scroll(function () {
                    if ($(window).scrollTop() < 0) {
                        $("#gnh_scroll").css({'position': 'relative'});
                    } else {
                        $("#gnh_scroll").css({'position': 'fixed'});
                    }
                });
            });
//            var t = $('#gnh_scroll').position().top; //lấy vị trí của phần trang web gán cho biến t
//
...
//            return false;
    ...
    <body class="container-fluid" id="gnh-body">
